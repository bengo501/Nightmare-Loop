...
<p align="center">
  <img src="assets/textures/backGROUND.png" alt="corredor em pedra com tochas" width="720">
</p>
...
## imagens neste readme

as imagens são ficheiros do próprio projeto (não são links externos). se mudares caminhos de `assets/`, atualiza as referências acima.
